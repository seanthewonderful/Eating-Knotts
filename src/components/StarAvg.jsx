...
export default function StarAvg({ starAvg }) {
	...
	switch (true) {
		...
		case (starAvg < 3.75 && starAvg > 3.25):
			return (
				<>
				<i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-half"></i><i className="bi bi-star"></i>
				</>
			)
		...
		case (starAvg < 2.75 && starAvg > 2.25):
			return (
				<>
				<i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-half"></i><i className="bi bi-star"></i><i className="bi bi-star"></i>
				</>
			)
		case (starAvg < 2.25 && starAvg > 1.75):
			return (
				<>
				<i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star"></i><i className="bi bi-star"></i><i className="bi bi-star"></i>
				</>
				)
		case (starAvg < 1.75 && starAvg > 1.25):
			return (
				<>
				<i className="bi bi-star-fill"></i><i className="bi bi-star-half"></i><i className="bi bi-star"></i><i className="bi bi-star"></i><i className="bi bi-star"></i>
				</>
			)
		...
		case (starAvg < 0.75 && starAvg > 0):
			return (
				<>
				<i className="bi bi-star-half"></i><i className="bi bi-star"></i><i className="bi bi-star"></i><i className="bi bi-star"></i><i className="bi bi-star"></i>
				</>
			)
		case (starAvg === 0):
			return (
